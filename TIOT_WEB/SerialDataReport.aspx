<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SerialDataReport.aspx.cs" Inherits="TIOT_WEB.SerialDataReport" %>
    ...
    <script type="text/javascript">
        ...
        $("#myModal").on("shown.bs.modal", function () {
            ...
            if (typeof temptable !== 'undefined' && temptable.length > 0) {
                getDateTimeGraph('chart', data, 'spline', 'Serial Chart', temptable[0][0]);
            }
        });
    </script>
</asp:Content>
