<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RelayVoltageReport.aspx.cs" Inherits="TIOT_WEB.RelayVoltageReport" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-1 col-md-6 col-sm-12 customCol">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtmin" ClientIDMode="Static" placeholder="Low" Text="150" runat="server" CssClass="form-control ddl"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-1 col-md-6 col-sm-12 customCol">
                    <div class="form-group">
                        <asp:Label runat="server" CssClass="control-label lbl">High</asp:Label>
                        <asp:TextBox ID="txtmax" ClientIDMode="Static" placeholder="High" Text="300" runat="server" CssClass="form-control ddl"></asp:TextBox>
                    </div>
                </div>
            ...
            <div class="row">
                <asp:GridView ID="gvdReport" ClientIDMode="Static" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found!">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Voltage (V)" DataField="Value" />
    ...
    <script type="text/javascript">
        ...
        $("#myModal").on("shown.bs.modal", function () {
            ...
            if (typeof temptable !== 'undefined' && temptable.length > 0) {
                getDateTimeGraph('chart', data, 'spline', 'Voltage Chart', temptable[0][0]);
            }
        });
