<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RelayCurrentReport.aspx.cs" Inherits="TIOT_WEB.RelayCurrentReport" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-1 col-md-6 col-sm-12  customCol ddlWidth">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlobjectSensor" ClientIDMode="Static" runat="server" class="dropdown-toggle form-control ddl ddlSelect"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-1 col-md-6 col-sm-12  customCol ddlWidth">
                    <div class="form-group">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 customCol">
                ...
                <div class="col-lg-1 col-md-6 col-sm-12 customCol">
                    <div class="form-group">
                        <asp:Label runat="server" CssClass="control-label lbl">Low</asp:Label>
                        <asp:TextBox ID="txtmin" ClientIDMode="Static" placeholder="Low" runat="server" Text="0" CssClass="form-control ddl"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-1 col-md-6 col-sm-12 customCol">
                    <div class="form-group">
                        <asp:Label runat="server" CssClass="control-label lbl ">High</asp:Label>
                        <asp:TextBox ID="txtmax" ClientIDMode="Static" placeholder="High" runat="server" Text="4" CssClass="form-control ddl"></asp:TextBox>
                    </div>
                </div>

            </div>
            <div class="row">
                <div class="col-lg-1 col-md-6 col-sm-12 pull-right">
                    <div class="form-group">
                ...
                <div class="col-lg-1 col-md-6 col-sm-12 pull-right">
                    <div class="form-group" id="btngraph" runat="server">
                        <button type="button" class="btn bg-primary btn-block btn-xs" data-toggle="modal" data-target="#myModal">Graph</button>
            ...
            <div class="row">
                ...
                <asp:GridView ID="gvdReport" ClientIDMode="Static" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found!">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Cuurent (A)" DataField="Value" />
