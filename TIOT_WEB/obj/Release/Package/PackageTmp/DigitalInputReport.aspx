<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DigitalInputReport.aspx.cs" Inherits="TIOT_WEB.DigitalInputReport" %>
            ...
            <div class="row">
                <asp:GridView ID="gvdReport" ClientIDMode="Static" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found!">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Value" DataField="Status" />
                        <asp:BoundField HeaderText="Start Time" DataField="StartTime" />
                        <asp:BoundField HeaderText="End Time" DataField="EndTime" />
                        <asp:BoundField HeaderText="TotalTime (hh:mm:ss)" DataField="TotalTime" />
                    </Columns>
                </asp:GridView>
            </div>
        ...
        <div class="modal-dialog dashboardpopup">
            <div class="modal-content">
                <div class="modal-body modalbodyheight">
                    <div id="chart" class="chart" style="padding-top:40px" ></div>
                </div>
