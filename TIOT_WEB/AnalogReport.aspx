<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AnalogReport.aspx.cs" Inherits="TIOT_WEB.AnalogReport" %>
            ...
            <div class="row">
              ...
              <div class="col-lg-1 col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtmax" ClientIDMode="Static" placeholder="High" Text="1" runat="server" CssClass="form-control ddl"></asp:TextBox>
                    </div>
                </div>
